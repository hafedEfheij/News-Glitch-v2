...
const FACT_CHECK_API_KEY = process.env.FACT_CHECK_API_KEY || 'your_fact_check_api_key_here';
const HF_API_KEY = process.env.HF_API_KEY || 'your_huggingface_api_key_here';
const CLAIMBUSTER_API_KEY = process.env.CLAIMBUSTER_API_KEY || 'your_claimbuster_api_key_here';
const GEMINI_API_KEY = process.env.GOOGLE_GENAI_API_KEY || 'your_google_genai_api_key_here';
